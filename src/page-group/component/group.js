...
const titleConfigMap = {
  0: intl
    .get('ide.src.page-group.component.group.bn0kn06e3nm')
    .d('实体属性满足'),
  1: intl
    .get('ide.src.page-group.component.group.yfky8jx528q')
    .d('实体关系满足'),
}

const titleSetMap = {
  0: intl
    .get('ide.src.page-group.component.group.jjm9qfrkw6m')
    .d('关系属性满足'),
  1: intl
    .get('ide.src.page-group.component.group.2kppt33quks')
    .d('关联实体满足'),
}
