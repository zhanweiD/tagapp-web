  ...
  render() {
    ...
    return (
      <div className="time-range">
        <label className="pr8">
          {intl
            .get('ide.src.component.time-range.time-range.k20vwc1g25')
            .d('时间设置')}
        </label>
        <Select
          className="pr8"
        ...
        >
          ...
          {custom && (
            <Option value="custom">
              {intl
                .get('ide.src.component.time-range.time-range.5gjye00zd8i')
                .d('自定义')}
            </Option>
          )}
        </Select>
        ...
        />
        {intl
          .get('ide.src.component.time-range.time-range.ygze1wwz56j')
          .d('至')}
